  ...
  return (
    <main className="quest-page">
      <header className="quest-content space-y-4">
        <h1 className="quest-title text-4xl sm:text-5xl">
          Choose your profile avatar
        </h1>
        <p className="quest-subtitle max-w-2xl">
          Pick the avatar style you want to see on your learning journey. Later,
          learners will be able to change it from their profile.
        </p>
      </header>
